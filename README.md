...
| `out/geography.csv` | 學年度 × **22 縣市** × 等級別（104–114）：出生戶籍地、學校所在地、淨流動、就學戶籍比 |
...
**臺東縣有八成的原民生離開臺東就學。** 承接端集中在臺北、臺中、高雄、臺南。
...
1. **沒有一般生對照。** 全體學生的開放資料沒有出生地，`sdata` 也沒有——本專案其他
   維度都有的「原民 vs 一般生」在這裡做不出來，只能自己跟自己比。
   （學校所在地端理論上可以用學校代碼對校址推出全體數，但那要另外一份校址對照表。）
